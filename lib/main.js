    ...
    fs.readdir(path, async function(err, items) {
        for (var i=0; i<items.length; i++) {
            ...
            try {
                ...
                console.log('upload_url_string', upload_url_string)
                ...
                const { data: { browser_download_url: browser_download_url }} = await octokit.repos.uploadReleaseAsset({url: upload_url_string, headers, name: file_name, file})
